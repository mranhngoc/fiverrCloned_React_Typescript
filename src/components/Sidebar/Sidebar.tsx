...
import { JobMenuModel } from '../../Models/jobMenu/jobMenuModel';
      ...
      <div className='sidebar__main'>
        <div className='sidebar__header'>
          {userLogin ? (
            ...
            <NavLink to='/users/register'>Join Fiverr</NavLink>
          )}
        </div>
        <div className='sidebar__wrapper'>
          <div className='sidebar__menu'>
            ...
            <div className='sidebar__categories'>
              <div className='sidebar__wrap'>
                <div
                  ...
                  onClick={() => handleCategory('.sidebar__categories')}
                >
                      ...
                      <li className='categories-list' key={i}>
                        ...
                        <ul>
                          {jobs.dsNhomChiTietLoai.map((job, t) => {
                            return (
                              <li className='categories-list-name' key={t}>
            ...
            <div
              className='sidebar__explore'
              onClick={() => handleCategory('.sidebar__explore')}
            >
          ...
          <div className='sidebar__general'>
            ...
            <div className='general-home'>Home</div>
            <div className='general-language'>Language</div>
            <div className='general-money'>US$ USD</div>
            <p>Open In App</p>
          </div>
        </div>
      </div>
